    ...
    <div className="container-fluid">
      ...
      {currentView === 'menu' && (
        <div className="no-print d-flex justify-content-center align-items-center gap-4 flex-wrap" style={{ minHeight: '50vh' }}>
          <button
            className="card shadow-sm border-primary text-center p-4 hover-shadow"
            style={{
              width: '18rem', cursor: 'pointer', border: '1px solid #0d6efd', background: 'white',
            }}
            onClick={() => handleViewChange('tools')}
            type="button"
          >
            <div className="card-body">
              <div className="text-primary"><i className="bi bi-tools fs-1" aria-hidden="true" /></div>
              <h3 className="mt-3">Herramientas</h3>
              <p className="text-muted">Ver rankings y stock</p>
            </div>
          </button>

          <button
            className="card shadow-sm border-success text-center p-4 hover-shadow"
            style={{
              width: '18rem', cursor: 'pointer', border: '1px solid #198754', background: 'white',
            }}
            onClick={() => handleViewChange('clients')}
            type="button"
          >
            <div className="card-body">
              <div className="text-success"><i className="bi bi-people fs-1" aria-hidden="true" /></div>
          ...
          <button
            className="card shadow-sm border-info text-center p-4 hover-shadow"
            style={{
              width: '18rem', cursor: 'pointer', border: '1px solid #0dcaf0', background: 'white',
            }}
            onClick={() => handleViewChange('loans')}
            type="button"
          >
            <div className="card-body">
              <div className="text-info"><i className="bi bi-journal-text fs-1" aria-hidden="true" /></div>
              <h3 className="mt-3">Préstamos</h3>
      ...
      {currentView !== 'menu' && (
        <div className="no-print mb-5 d-flex justify-content-center flex-column align-items-center">
          <button type="button" className="btn btn-outline-secondary mb-3 align-self-start ms-5" onClick={() => handleViewChange('menu')}>
                ...
                <div className="card-body d-flex flex-column gap-3">
                  ...
                  <div className="border-bottom pb-3">
                    ...
                    <div className="d-flex gap-2">
                      <button type="button" className="btn btn-primary w-50" onClick={() => getBestToolsHistoric(false)}>Generar en Pantalla</button>
                      <button type="button" className="btn btn-outline-dark w-50" onClick={() => getBestToolsHistoric(true)}>Descargar PDF</button>
                    </div>
                  </div>
                  {/* 1.2 */}
                  <div className="border-bottom pb-3">
                    ...
                    <div className="d-flex gap-2">
                      <button type="button" className="btn btn-primary w-50" onClick={() => getBestToolsByDate(false)}>Generar</button>
                      <button type="button" className="btn btn-outline-dark w-50" onClick={() => getBestToolsByDate(true)}>Descargar PDF</button>
                    </div>
                  </div>
                  {/* 1.3 */}
                  <div>
                    ...
                    <div className="d-flex gap-2">
                      <button type="button" className="btn btn-primary w-50" onClick={() => getAllTools(false)}>Ver Inventario</button>
                      <button type="button" className="btn btn-outline-dark w-50" onClick={() => getAllTools(true)}>Descargar Inventario</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card h-100 shadow-sm border-success">
                ...
                <div className="card-body d-flex flex-column gap-3">
                  ...
                  <div className="border-bottom pb-3">
                    ...
                    <div className="d-flex gap-2">
                      <button type="button" className="btn btn-success w-50" onClick={() => getClients('ACTIVO', 'Clientes Activos', false)}>Ver Lista</button>
                      <button type="button" className="btn btn-outline-dark w-50" onClick={() => getClients('ACTIVO', 'Clientes Activos', true)}>Descargar PDF</button>
                    </div>
                  </div>
                  {/* 2.2 */}
                  <div className="border-bottom pb-3">
                    ...
                    <div className="d-flex gap-2">
                      <button type="button" className="btn btn-warning w-50" onClick={() => getClients('RESTRINGIDO', 'Clientes Restringidos', false)}>Ver Lista</button>
                      <button type="button" className="btn btn-outline-dark w-50" onClick={() => getClients('RESTRINGIDO', 'Clientes Restringidos', true)}>Descargar PDF</button>
                    </div>
                  </div>
                  {/* 2.3 */}
                  <div>
                    ...
                    <div className="d-flex gap-2">
                      <button type="button" className="btn btn-success w-50" onClick={() => getClients('ALL', 'Todos los Clientes', false)}>Ver Todos</button>
                      <button type="button" className="btn btn-outline-dark w-50" onClick={() => getClients('ALL', 'Todos los Clientes', true)}>Descargar PDF</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card h-100 shadow-sm border-info">
                ...
                <div className="card-body d-flex flex-column gap-3">
                    ...
                    <div className="d-flex gap-3 mt-2">
                      <div className="w-50">
                        ...
                        <div className="btn-group w-100">
                          <button type="button" className="btn btn-info text-white" onClick={() => getLoans('ACTIVO', 'Préstamos Activos', false)}>Ver</button>
                          <button type="button" aria-label="Descargar préstamos activos" className="btn btn-outline-dark" onClick={() => getLoans('ACTIVO', 'Préstamos Activos', true)}><i className="bi bi-download" /></button>
                        </div>
                      </div>
                      <div className="w-50">
                        <p className="small fw-bold mb-1">Finalizados</p>
                        <div className="btn-group w-100">
                          <button type="button" className="btn btn-secondary" onClick={() => getLoans('FINALIZADO', 'Préstamos Finalizados', false)}>Ver</button>
                          <button type="button" aria-label="Descargar préstamos finalizados" className="btn btn-outline-dark" onClick={() => getLoans('FINALIZADO', 'Préstamos Finalizados', true)}><i className="bi bi-download" /></button>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-bottom pb-3">
                    ...
                    <div className="d-flex gap-3">
                      <div className="w-50">
                        ...
                        <div className="btn-group w-100">
                          <button type="button" className="btn btn-info text-white" onClick={() => getLoansByDate('ACTIVO', 'Préstamos Activos en Rango', false)}>Ver</button>
                          <button type="button" aria-label="Descargar préstamos activos en rango" className="btn btn-outline-dark" onClick={() => getLoansByDate('ACTIVO', 'Préstamos Activos en Rango', true)}><i className="bi bi-download" /></button>
                        </div>
                      </div>
                      <div className="w-50">
                        <p className="small fw-bold mb-1">Finalizados en rango</p>
                        <div className="btn-group w-100">
                          <button type="button" className="btn btn-secondary" onClick={() => getLoansByDate('FINALIZADO', 'Préstamos Finalizados en Rango', false)}>Ver</button>
                          <button type="button" aria-label="Descargar préstamos finalizados en rango" className="btn btn-outline-dark" onClick={() => getLoansByDate('FINALIZADO', 'Préstamos Finalizados en Rango', true)}><i className="bi bi-download" /></button>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="d-flex gap-2">
                      <button type="button" className="btn btn-primary w-50" onClick={() => getLoans(null, 'Todos los Préstamos', false)}>Ver Historial</button>
                      <button type="button" className="btn btn-outline-dark w-50" onClick={() => getLoans(null, 'Todos los Préstamos', true)}>Descargar Todo</button>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <table className="table table-bordered table-striped">
            ...
            <tbody>
              {reportData.map((loan) => (
                <tr key={loan.idLoan}>
                  <td>{loan.idLoan}</td>
                  <td>{loan.idClient?.nameClient || loan.idClient}</td>
                  {' '}
                  {/* Handle object or ID ref */}
      ...
      {currentView === 'menu' && (
        <div className="text-center mt-5 no-print">
          ...
          >
            <button type="button" className="btn btn-warning" onClick={() => window.history.back()}>Volver al Inicio</button>
          </OverlayTrigger>
        </div>
      )}
    </div>
